 ...
 */
@Beta
public class ActivityRule<T extends Activity> extends UiThreadTestRule {
    ...
    private T mActivity;
    /**
     * Similar to {@link #ActivityRule(Class, boolean, boolean)} but with "touch mode" disabled.
     *
     * @param activityClass    The activity under test. This must be a class in the instrumentation
     *                         targetPackage specified in the AndroidManifest.xml
     * @see ActivityRule#ActivityRule(Class, boolean, boolean)
     */
    public ActivityRule(Class<T> activityClass) {
        this(activityClass, false);
    }
    /**
     * Similar to {@link #ActivityRule(Class, boolean, boolean)} but defaults to launch the
     ...
     * @see ActivityRule#ActivityRule(Class, boolean, boolean)
     */
    public ActivityRule(Class<T> activityClass, boolean initialTouchMode) {
        this(activityClass, initialTouchMode, true);
    }
    /**
     * Creates an {@link ActivityRule} for the Activity under test.
     *
     * @param activityClass    The activity under test. This must be a class in the instrumentation
     *                         targetPackage specified in the AndroidManifest.xml
     * @param initialTouchMode true if the Activity should be placed into "touch mode" when started
     ...
     * {@link ActivityRule#ActivityRule(Class, boolean, boolean)}.
     * <p>
     * Usage:
     * <pre>
     *    &#064;Test
     ...
     *                    {@link ActivityRule#getActivityIntent()} is used.
     * @return the Activity launched by this rule.
     * @see ActivityRule#getActivityIntent()
     */
